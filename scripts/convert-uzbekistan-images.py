#!/usr/bin/env python3
"""
Script to convert Uzbekistan images from JPG to WebP in multiple sizes.
...
def process_uzbekistan_images():
    """Process all images in the uzbekistan folder"""
    base_dir = Path('/Users/pankhuriandkaushal/CodeExperiments/travel-website/public/images/uzbekistan')
